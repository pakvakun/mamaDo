    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Header
                    centerComponent={{ text: 'О сервисе', style: { color: '#FFF', fontFamily: 'SF Pro Text', fontSize: 17, fontWeight: '500' } }}
                    containerStyle={{
                ...
                <View style={styles.textContainer}>
                    <ScrollView contentContainerStyle={styles.scrollContainer}>
                        <Text style={styles.textTitle}>MamaDo</Text>
                        ...
                        <Text style={styles.textTitle}>За нами будущее</Text>
                        <Text style={styles.textP}>
