...
export default class Insta extends Component {
    ...
    render(){
        return(
            <View style={{position: 'absolute', flex: 1, width: '100%', height: '100%', bottom: this.props.instagram ? '0%' : '-100%', paddingTop: 50, paddingBottom: 50, backgroundColor: 'rgba(0,0,0, .5)'}}>
                ...
                <View style={[styles.buttonsBlock, { justifyContent: 'center', alignItems: 'center' ,  width: '100%'}]}>
                    <TouchableOpacity onPress={()=>this.props.toggleInstagram()} style={[styles.buttonLogin, {position: 'absolute', bottom: 50,  width: '80%'}]}>
